...
| 入口 | 链接 |
|------|------|
| 🖥️ 数字孪生大屏 | <https://dcd63df0dc9844bb8e3f492abb3e65eb.app.workbuddy.link/> |
| 📚 配套文档合集 | <https://dcd63df0dc9844bb8e3f492abb3e65eb.app.workbuddy.link/docs/> |

> 站点已把 **Cesium 1.114 + 4 张工艺图** 本地化，加载零外部 CDN 依赖（除异步 Google Fonts），国内可直接打开。
